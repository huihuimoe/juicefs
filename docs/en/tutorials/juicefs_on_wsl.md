...
JuiceFS is a distributed file system with data and metadata separated, usually using object storage as data storage and a Redis-compatible database as metadata storage. It is assumed here that the following materials have been prepared.
